...
wkv_cuda = load(name="wkv", sources=[r"E:\PycharmProjects\rwkv-diffusion\Diffusion-RWKV-main\cuda\wkv_op.cpp", r"E:\PycharmProjects\rwkv-diffusion\Diffusion-RWKV-main\cuda\wkv_cuda.cu"],
                verbose=True, extra_cuda_cflags=['-res-usage', '--maxrregcount=60', '--use_fast_math', '-O3', '-Xptxas=-O3', f'-DTmax={T_MAX}'],
                extra_include_paths=["path/to/your/include"],  # 如果需要，指定额外的头文件路径
                extra_ldflags=["-Lpath/to/your/lib"]  # 如果需要，指定额外的库路径
                )
